...
FUTURE PLANS:
  ...
  Set a temporary directory option, as combining all the fragments and audio takes a bit on HDD"s. Setting a temporary folder in ~ could allow the files to be downloaded and merged faster, then moved to the proper download folder.
